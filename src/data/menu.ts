...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { name: { en: "S2 · Wonton Soup", fr: "S2 · Soupe Wonton" }, desc: { en: "Silky pork & shrimp wontons in a fragrant, soul-warming broth", fr: "Wontons soyeux au porc et crevettes dans un bouillon parfumé et réconfortant" }, price: "7/16", img: "/images/wonton-soup.jpg" },
