...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { name: { en: "S1 · Bangkok Soup", fr: "S1 · Soupe Bangkok" }, desc: { en: "Our signature red curry coconut broth · Large with chicken strips", fr: "Notre signature — bouillon de coco au curry rouge · Grand avec lanières de poulet" }, price: "7/16", popular: true, chefSpecial: true, img: "/images/bangkok-soup.jpg" },
      { name: { en: "S2 · Wonton Soup", fr: "S2 · Soupe Wonton" }, desc: { en: "Pork & shrimp wontons in a fragrant broth · Large with 2 shrimps", fr: "Wontons au porc et crevettes dans un bouillon parfumé · Grand avec 2 crevettes" }, price: "7/16", img: "/images/wonton-soup.jpg" },
      ...
      { name: { en: "S4 · Tom Yum Koong", fr: "S4 · Tom Yum Koong" }, desc: { en: "Thailand's iconic hot & sour soup — shrimp, mushrooms, bamboo & pineapple in a bold lemongrass broth · Small: 2 shrimps · Large: 7 shrimps", fr: "La soupe aigre-piquante iconique de Thaïlande — crevettes, champignons, bambou et ananas dans un bouillon de citronnelle · Petit : 2 crevettes · Grand : 7 crevettes" }, price: "7/16", spicy: true },
      { name: { en: "S5 · Tom Kha Koong", fr: "S5 · Tom Kha Koong" }, desc: { en: "Sweet & sour coconut broth with shrimp, lemongrass, mushrooms, bamboo & pineapple · Small: 2 shrimps · Large: 7 shrimps", fr: "Bouillon de coco aigre-doux avec crevettes, citronnelle, champignons, bambou et ananas · Petit : 2 crevettes · Grand : 7 crevettes" }, price: "7/16" },
