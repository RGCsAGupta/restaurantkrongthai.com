...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { name: { en: "S1 · Bangkok Soup", fr: "S1 · Soupe Bangkok" }, desc: { en: "Our signature — velvety coconut broth with fragrant lemongrass · Large comes with shrimp, chicken & mushrooms", fr: "Notre signature — bouillon de coco velouté à la citronnelle parfumée · Grand format avec crevettes, poulet et champignons" }, price: "7/16", popular: true, chefSpecial: true, img: "/images/bangkok-soup.jpg" },
