...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { name: { en: "S1 · Bangkok Soup (Small)", fr: "S1 · Soupe Bangkok (Petite)" }, desc: { en: "Our signature red curry coconut broth", fr: "Notre signature — bouillon de coco au curry rouge" }, price: "7", popular: true, chefSpecial: true, img: "/images/bangkok-soup.jpg" },
      { name: { en: "S1 · Bangkok Soup (Large)", fr: "S1 · Soupe Bangkok (Grande)" }, desc: { en: "Our signature red curry coconut broth with chicken strips", fr: "Notre signature — bouillon de coco au curry rouge avec lanières de poulet" }, price: "16", popular: true, chefSpecial: true, img: "/images/bangkok-soup.jpg" },
      { name: { en: "S2 · Wonton Soup (Small)", fr: "S2 · Soupe Wonton (Petite)" }, desc: { en: "Pork & shrimp wontons in a fragrant broth", fr: "Wontons au porc et crevettes dans un bouillon parfumé" }, price: "7", img: "/images/wonton-soup.jpg" },
      { name: { en: "S2 · Wonton Soup (Large)", fr: "S2 · Soupe Wonton (Grande)" }, desc: { en: "Pork & shrimp wontons in a fragrant broth with 2 shrimps", fr: "Wontons au porc et crevettes dans un bouillon parfumé avec 2 crevettes" }, price: "16", img: "/images/wonton-soup.jpg" },
      { name: { en: "S3 · Phnom Penh Soup", fr: "S3 · Soupe Phnom Penh" }, desc: { en: "A comforting Cambodian classic — tender chicken & steamed rice in a clean broth with a hint of lemon", fr: "Un classique cambodgien réconfortant — poulet tendre et riz vapeur dans un bouillon clair avec un soupçon de citron" }, price: "7/16", img: "/images/phnom-penh-soup.jpg" },
      { name: { en: "S4 · Tom Yum Koong (Small)", fr: "S4 · Tom Yum Koong (Petit)" }, desc: { en: "Thailand's iconic hot & sour soup — 2 shrimps, mushrooms, bamboo & pineapple in a bold lemongrass broth", fr: "La soupe aigre-piquante iconique de Thaïlande — 2 crevettes, champignons, bambou et ananas dans un bouillon de citronnelle" }, price: "7", spicy: true },
      { name: { en: "S4 · Tom Yum Koong (Large)", fr: "S4 · Tom Yum Koong (Grand)" }, desc: { en: "Thailand's iconic hot & sour soup — 7 shrimps, mushrooms, bamboo & pineapple in a bold lemongrass broth", fr: "La soupe aigre-piquante iconique de Thaïlande — 7 crevettes, champignons, bambou et ananas dans un bouillon de citronnelle" }, price: "16", spicy: true },
      { name: { en: "S5 · Tom Kha Koong (Small)", fr: "S5 · Tom Kha Koong (Petit)" }, desc: { en: "Sweet & sour coconut broth with 2 shrimps, lemongrass, mushrooms, bamboo & pineapple", fr: "Bouillon de coco aigre-doux avec 2 crevettes, citronnelle, champignons, bambou et ananas" }, price: "7" },
      { name: { en: "S5 · Tom Kha Koong (Large)", fr: "S5 · Tom Kha Koong (Grand)" }, desc: { en: "Sweet & sour coconut broth with 7 shrimps, lemongrass, mushrooms, bamboo & pineapple", fr: "Bouillon de coco aigre-doux avec 7 crevettes, citronnelle, champignons, bambou et ananas" }, price: "16" },
      { name: { en: "S6 · Vegetable Soup", fr: "S6 · Soupe aux légumes" }, desc: { en: "Mild Thai-style broth with mushrooms, napa cabbage, peas & carrots", fr: "Bouillon thaï doux avec champignons, choux chinois, petit pois et carottes" }, price: "7/16", img: "/images/vegetable-soup.jpg" },
    ],
  },
  {
    id: "meal-soups",
  ...
  },
  {
    ...
    items: [
      ...
      { name: { en: "B2 · Banh Hoi", fr: "B2 · Banh Hoi" }, desc: { en: "Delicate Cambodian rice vermicelli paired with smoky grilled meat, crisp herbs & a rich dipping sauce", fr: "Fines vermicelles de riz cambodgiennes accompagnées de viande grillée fumée, herbes croquantes et une riche sauce" }, price: "26", img: "/images/banh-hoi.jpg" },
    ],
  },
  {
    id: "vegetarian",
