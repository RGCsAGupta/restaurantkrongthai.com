...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: { en: "F7 · General's Shrimps", fr: "F7 · Crevettes du Général" }, desc: { en: "Extra-crispy battered shrimps smothered in our addictive sweet & spicy General's glaze", fr: "Crevettes panées extra-croustillantes enrobées de notre glaçage sucré et épicé du Général irrésistible" }, price: "23", spicy: true },
