export default {
  ...
  specials: {
    ...
    lunchCombo: "Combo 1 personne",
    lunchComboDesc: "Tout plat principal + soupe, entrée, riz jasmin, café ou thé, biscuits aux amandes",
    lunchComboPrice: "+10 $",
    dinnerCombo: "Menu fixe 2 personnes",
    dinnerComboDesc: "Choix de 3 menus fixes pour deux — soupe, entrées, plats, riz, dessert",
    dinnerComboPrice: "60 $",
    familyCombo: "Menu fixe 4 personnes",
    familyComboDesc:
      "Menu fixe complet : soupe, entrées, 4 plats principaux, riz, dessert",
    ...
    winterDishes: "Soupe Bangkok, Cari vert, Pho, Tom Yum Koong",
    ...
    springDishes: "Rouleaux de printemps, Salade de mangue, Salade cambodgienne, Légumes asiatiques",
    ...
    summerDishes: "Rouleaux de printemps, Pad Thai, Panang au tofu, Crevettes thaïes",
    ...
    fallDishes: "Nid Royal, Cari rouge, Soupe Phnom Penh, Soupe Bangkok",
    cta: "Commander maintenant",
  },
  notFound: {
