export default {
  ...
  catering: {
    ...
    policyLeadTime: "Veuillez réserver au moins 5 jours ouvrables à l'avance",
    policyDietary: "Options végétariennes, sans gluten et adaptations pour allergies sur demande",
  ...
  specials: {
    ...
    combo1: "Combo 1 personne",
    combo1Desc: "Ajoutez à tout plat principal : choix de soupe, entrée, riz jasmin, café ou thé, biscuits aux amandes",
    combo1Price: "+10 $",
    combo2: "2 personnes — Menu fixe",
    combo2Desc: "Choix de 3 menus fixes pour deux — chacun comprend soupe, entrées, deux plats avec riz, dessert",
    combo2Price: "60 $",
    combo3: "2 personnes — Jardin Éternel",
    combo3Desc: "Notre menu signature pour couple — une expérience gastronomique spécialement créée pour deux",
    combo3Price: "60 $",
    combo4: "3 personnes — Menu fixe",
    combo4Desc: "Choix de 2 menus fixes pour trois — soupe, entrées, trois plats avec riz, dessert",
    combo4Price: "85 $",
    combo5: "4 personnes — Menu fixe",
    combo5Desc: "Festin complet pour quatre — soupe, entrées, quatre plats avec riz, dessert. Parfait pour les familles",
    combo5Price: "110 $",
    substitutionNote: "3 $ de supplément pour les substitutions",
    ...
    bestSeller1Desc: "Notre bouillon de coco signature avec crevettes, poulet, champignons et citronnelle — 7 $ petit / 16 $ grand",
    bestSeller2: "Pad Thai",
    bestSeller2Desc: "Nouilles de riz sautées classiques au tamarin, fèves germées, arachides et lime — à partir de 21 $",
    bestSeller3: "Rouleaux impériaux",
    bestSeller3Desc: "Rouleaux dorés croustillants farcis de porc assaisonné avec sauce maison — 6 $",
    ...
    winterDishes: "Soupe Bangkok 7 $/16 $, Cari vert 21 $, Pho 18 $, Tom Yum Koong 7 $/16 $",
    ...
    springDishes: "Rouleaux de printemps 9 $, Salade de mangue 12 $, Salade cambodgienne 10 $, Légumes asiatiques 19 $",
    summerTitle: "Favoris d'été",
    summerDesc: "Combattez la chaleur avec des rouleaux de printemps, un Pad Thai piquant et des plats légers aux légumes frais.",
    summerDishes: "Rouleaux de printemps 9 $, Pad Thai 21 $, Panang au tofu 19 $, Crevettes thaïes 23 $",
    ...
    fallDishes: "Nid Royal 22 $, Cari rouge 21 $, Soupe Phnom Penh 7 $/16 $, Soupe Bangkok 7 $/16 $",
    cta: "Commander maintenant",
    mostPopularBadge: "Plus populaire — Meilleur rapport qualité-prix",
    groupDealBadge: "Offre de groupe",
    comboIncludes1: "Soupe au choix",
    comboIncludes2: "Entrée au choix",
    comboIncludes3: "Café ou thé + biscuits",
    perPersonNote: "par personne, ajouté à tout plat principal",
  },
  promo: {
    badge: "+10 $",
    text: "Transformez tout plat en festin — soupe, entrée, café et biscuits inclus",
    cta: "Voir l'offre",
    dismiss: "Fermer",
    ariaLabel: "Bannière promotionnelle pour le combo Table d'hôte",
  },
  notFound: {
  ...
  about: {
    ...
    timeline1999: "Fondation — Ouverture du premier restaurant cambodgien authentique de la région aux Promenades de l'Outaouais",
    timeline2009: "Nouveau chez-soi — Après près d'une décennie au centre commercial, la famille s'installe au 205, rue Bellehumeur à Gatineau",
  ...
  menu: {
    ...
    comboNote: "Ajoutez un combo repas complet pour +10 $",
    comboIncludes: "Choix de soupe, entrée, riz jasmin, café ou thé, biscuits aux amandes",
    ...
    comboBadge: "Plus populaire",
    comboViewDeals: "Voir toutes les offres combo",
    tableDhoteSubtitle: "Transformez tout plat en expérience culinaire complète",
    bestValue: "Meilleur rapport qualité-prix",
  },
  menuItem: {
    backToMenu: "Retour au menu complet",
    moreFrom: "Plus de",
    comboUpgrade: "Ajoutez un combo Table d'hôte",
    comboUpgradeDesc: "Soupe + entrée + riz jasmin + café ou thé + biscuits aux amandes",
    comboPrice: "+10 $",
    popular: "Populaire",
    ...
    comboBadge: "Plus populaire",
    comboItem1: "Soupe au choix",
    comboItem2: "Entrée au choix",
    comboItem3: "Café ou thé + biscuits",
    viewAllCombos: "Voir toutes les options combo",
    comboOrderCta: "Commander",
    customizeTitle: "Personnalisez votre repas",
  },
  gallery: {
  ...
  areas: {
    ...
    gatineauText: "Situé au 205, rue Bellehumeur au cœur de Gatineau, Krong Thai sert une cuisine authentique d'Asie du Sud-Est depuis 1999 — d'abord aux Promenades de l'Outaouais, puis à notre adresse actuelle depuis 2009. À quelques minutes de la Maison de la Culture de Gatineau, avec stationnement gratuit sur place. Dînez sur place, commandez pour emporter ou faites-vous livrer via UberEats, DoorDash et SkipTheDishes.",
    ...
    aylmerText: "Aylmer est à seulement 15 minutes de notre restaurant, et nous y livrons aussi. Vous planifiez un dîner en famille ou un événement traiteur à Aylmer? Nos forfaits traiteur commencent à 18 $ par personne et couvrent tout le secteur d'Aylmer incluant le Plateau, Rivermead et Deschênes.",
    ottawaTitle: "Cuisine Cambodgienne & Thaïe à Ottawa",
    ottawaText: "Nous sommes le restaurant cambodgien authentique le plus proche du centre-ville d'Ottawa — juste de l'autre côté du pont. Krong Thai est le seul restaurant de la région Ottawa-Gatineau servant des plats cambodgiens traditionnels comme la Soupe Phnom Penh et le Banh Hoi en plus des classiques thaïs et vietnamiens. Nous offrons le service traiteur à Ottawa incluant Centretown, le Glebe, Westboro et Kanata.",
    outaouaisTitle: "Au Service de la Région de l'Outaouais",
    outaouaisText: "De Buckingham à Chelsea, Krong Thai dessert la grande région de l'Outaouais avec service sur place, pour emporter, livraison et traiteur. Notre politique apportez votre vin (sans frais de bouchon) et le stationnement gratuit font de nous une destination populaire pour les soirées en couple, les dîners en famille et les célébrations de groupe dans toute la région.",
    orderCta: "Commander en ligne",
    cateringCta: "Demander une soumission traiteur",
    menuCta: "Voir notre menu",
    deliveryTitle: "Partenaires de livraison",
    deliveryText: "Commandez via votre application de livraison préférée — ou directement sur notre site pour emporter.",
    byobReminder: "Vous dînez sur place? Apportez votre vin — aucuns frais de bouchon!",
  },
  meta: {
    homeTitle:
    ...
    areasTitle: "Livraison Restaurant Thaï — Gatineau, Hull, Aylmer, Ottawa | Krong Thai",
    areasDesc: "Cuisine thaïe, vietnamienne et cambodgienne authentique livrée à Gatineau, Hull, Aylmer et Ottawa. Apportez votre vin, stationnement gratuit. Traiteur disponible dans toute la région.",
